%! TEX root = ../../master.tex
\lecture[Probabilistic method using independent events. Locász local lemma.]{Mi 17 Apr 2024}{Independent events}
% \begin{orga}
%      -----
% \end{orga}
...
\begin{lemma}[Symmetric \vocab{Loràsz Local Lemma}]
    \label{thm:lll}
